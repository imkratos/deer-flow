...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    editDescriptionPlaceholder: "简要说明这个智能体的用途",
    editModelLabel: "模型覆盖",
    editModelPlaceholder: "留空则使用默认模型",
    editToolGroupsLabel: "工具组",
    editSkillsLabel: "技能",
    editListPlaceholder: "每行一个，或用逗号分隔",
    editListHint: "留空表示沿用默认行为。",
    editSoulLabel: "SOUL.md",
    editSoulHint: "编辑该智能体的身份、行为方式、约束和工作风格。",
    editSoulPlaceholder: "在这里编写智能体的 SOUL.md 内容",
    editSaving: "保存中...",
    editSaveSuccess: "智能体已更新",
    editLoadError: "无法加载该智能体。",
  },
